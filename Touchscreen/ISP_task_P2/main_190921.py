...
2. made the default value
3. deleted the extra button which is appeared with failure
4. changed the background color as white blue and do not use BNW
5. when monkeys fail, immediately changed the background and do not show the black button

190909
1. changed BG color during ISI

190910
1. moved the center circle a little bit up
2. changed hold time (added more steps and more narrow width)
