"""
190912 - 190921
Move on to the Phase 2: Conditioning
1. Many things are changed in CO.kv and main.py file
2. conditioning stim and no stim using black and white response buttons

190924
1. Delete the BG color for stim
2. Add stim control TTL
3. Make stim on/off random
...
191008
1. Add some error information in the end screen
2. Adjust target positions
...
class COGame(Widget):
    ...
    periph_target1_BE = ObjectProperty(None)
    periph_target2_BE = ObjectProperty(None)
...
# dict(tt=[tt_15_sec.active, tt_30_sec.active, tt_45_sec.active, tt_60_sec.active]))
    ...
    def init(self, stims=None, animal_names_dict=None, rew_in=None, task_in=None,
        ...
        self.periph_target2_BE.move(self.periph_target2_pos)
...
# what are these?
        ...
        d = dict(animal_name=animal_name, center_target_rad=self.center_target_rad,
            ...
            center_error_counter = self.center_error_counter,
            target_error_counter = self.target_error_counter,
    ...
    def _start_center(self, **kwargs):
        if self.stim_order[self.total_counter] == 0:
            ...
            self.stims = 'stim_on'
        print('')            
        print('Trial num: ', self.trial_counter,'/', self.total_counter+1)
        print(self.stims)
    ...
    def _start_target(self, **kwargs):
        ...
        if self.stims == 'stim_on':
            ...
            self.periph_target2.color = bgcolor
            self.periph_target1_BE.color = (0., 0., 1., 1.)
            self.periph_target2_BE.color = bgcolor
        elif self.stims == 'stim_off':
            tgcolor = (1., 1., 1., 1.)
            self.periph_target1.color = bgcolor
            ...
            self.periph_target1_BE.color = bgcolor
            self.periph_target2_BE.color = (0., 0., 1., 1.)
    ...
    def touch_target(self, **kwargs):
        if self.drag_ok:
            if self.stims == 'stim_on':
                return self.check_if_cursors_in_targ_properly(self.periph_target1_position, self.periph_target_rad)
            elif self.stims == 'stim_off':
                return self.check_if_cursors_in_targ_properly(self.periph_target2_position, self.periph_target_rad)

        else:
            if self.stims == 'stim_on':
                return np.logical_and(self.check_if_cursors_in_targ_properly(self.periph_target1_position, self.periph_target_rad),
                    self.check_if_started_in_targ(self.periph_target1_position, self.periph_target_rad))
            elif self.stims == 'stim_off':
                return np.logical_and(self.check_if_cursors_in_targ_properly(self.periph_target2_position, self.periph_target_rad),
