...
const int offset = 1;
#define STBY 0
#define spin_IN1 8 ### 11
#define spin_IN2 9 ### 12
#define spin_PWM 4 ### 13; 
Motor motor_spin = Motor(spin_IN1, spin_IN2, spin_PWM, offset, STBY);

// Spin motor enocder
#define ENCODER_A   6 // 1 --> PH3; #### 3 
#define ENCODER_B   2 // 2 --> PE4; #### 2
...
// Slidepot sensor 
const int slidepot_sensor = A0; ### A0 -- slidepot
int pot_sensorValue;
...
// Lift IR sensor
const int Lift_IR = 52; ### 52    

// spinning IR
#define spin_IR 3 ### 38 

// FSR pins
const int analog_FSR1 = A14;#### A2
const int analog_FSR2 = A15;#### A1
