...
class R2Game(Widget):
    ...
    def init(self, animal_names_dict=None, rew_in=None, rew_var=None,
        ...
        autoquit_trls = [5, 10, 15, 20, 25, 35, 40, 50, 10**10]
        ...
        ### Trials to include ###
        trials_active_list = ['power_1', 'tripod_1', 'pinch_1', 'tiny_1', 
        'power_2', 'tripod_2', 'pinch_2', 'tiny_2', 
        'power_3', 'tripod_3', 'pinch_3', 'tiny_3']
        ...
        d = dict(animal_name=animal_name,
            ...
            trls_5 = autoquit['autoquit'][0], 
            trls_10 = autoquit['autoquit'][1],
            trls_15 = autoquit['autoquit'][2],
            trls_20 = autoquit['autoquit'][3], 
            trls_25 = autoquit['autoquit'][4],
            trls_35 = autoquit['autoquit'][5], 
            trls_40 = autoquit['autoquit'][6],
            trls_50 = autoquit['autoquit'][7], 
            trls_inf = autoquit['autoquit'][8], 
    ...
    def start_next_trial(self, **kwargs): 
        ...
        ### Only wait for gripper to go down 
        if self.beam == 0:
            return False 
        else: 
            return True 
...
class Manager(ScreenManager):
    ...
    if len(data_params.keys()) > 0: 
        ...
        power2 = BooleanProperty(False)
        tripod2 = BooleanProperty(False)
        pinch2 = BooleanProperty(False)
        tiny2 = BooleanProperty(False) 
        
        power3 = BooleanProperty(False)
        tripod3 = BooleanProperty(False)
        pinch3 = BooleanProperty(False)
        tiny3 = BooleanProperty(False) 
        ...
        for trl in data_params['trials_labels']: 
            ...
            if trl == 'power_1': 
                ...
                power2 = BooleanProperty(True)
            elif trl == 'tripod_2': 
                tripod2 = BooleanProperty(True)
            elif trl == 'pinch_2': 
                pinch2 = BooleanProperty(True)
            elif trl == 'tiny_2': 
                tiny2 = BooleanProperty(True)
            

            elif trl == 'power_3': 
                power3 = BooleanProperty(True)
            elif trl == 'tripod_3': 
                tripod3 = BooleanProperty(True)
            elif trl == 'pinch_3': 
                pinch3 = BooleanProperty(True)
            elif trl == 'tiny_3': 
                tiny3 = BooleanProperty(True)
