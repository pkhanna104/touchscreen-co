...
void go_to_target() {
  ...
  if (( diff > 0) or (n_tms < nthresh_tms) or (n_tms2 < nthresh_tms)) {
    ...
    if (keep_spinning) {
      ...
      motor_spin.drive(drivez, factor * tm);
    }
...
//  if ((count_spin_tm1 == 18) and (avg_vel > 0.7)) { // 18 // .7
//    deact_solenoid(); 
//  }
//  if ((count_spin_tm1 == 19) and (avg_vel > .6)) { //19 // .6
//    deact_solenoid(); 
//  }
//  if ((count_spin_tm1 == 20) and (avg_vel > .4)) { // .4
//      deact_solenoid(); 
//    }
//  if ((count_spin_tm1 == 21) and (avg_vel > .2)) { //.2
//    deact_solenoid();
// }
// if ((count_spin_tm1 == 22) and (avg_vel > .1)) { // .1
//    deact_solenoid(); 
// }
 if (count_spin_tm1 >= 10) {
  deact_solenoid(); 
 }
